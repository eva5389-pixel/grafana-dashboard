...
儀表板另設「磷化銦（InP）／高速光通訊供應鏈」專題模組，整理400G升級至800G、1.6T與CPO的產業脈絡，以及台灣、美國與中國A股研究名單。專題公司定位來自研究假設，須以公司法說、財報與公告持續驗證，不等同基金持股或投資建議。
...
- `data/workbook_funds.csv` 的活動績效快照會在每日流程中依實際地區過濾、同系列級別去重，再與已下載的逐日淨值資料合併；快照沒有逐日序列時，最大回撤與恢復期維持空白。
